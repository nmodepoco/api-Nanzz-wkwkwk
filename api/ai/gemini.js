...
module.exports = {
  ...
  creator: 'Nanzz',
  params: ['text'],
  'desc-text': 'Pertanyaan untuk Gemini AI',
  ...
  async run(req, res) {
    ...
    const inner = [
      [text, 0, null, null, null, null, 0], ['id'], ['', '', '', null, null, null, null, null, null, ''],
      tokenBlob, sessionId, null, [0], 1, null, null, 1, 0, null, null, null, null, null, [[0]], 0,
    ...
    const url = `https://gemini.google.com/_/BardChatUi/data/assistant.lamda.BardFrontendService/StreamGenerate?bl=boq_assistant-bard-web-server_20260603.11_p0&f.sid=${fSid}&hl=id&_reqid=${reqId}&rt=c`;
    ...
    try {
      ...
      return res.json({ status: !!textResult, creator: 'Nanzz', input: text, result: textResult || 'Gagal mendapatkan response' });
    } catch (err) {
